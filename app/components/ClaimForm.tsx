...
export default function AccidentClaimForm() {
    ...
    const initialFormData = {
        ...
        // checklist (ALL false by default)
                                ...
                                {[1, 2].map((num) => (
                                    <div key={num}>
                                        ...
                                        <input
                                            ...
                                            value={formData[`witness${num}_name`] || ""}
                                            onChange={handleChange}
                                            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-green-500 transition"
                                        />
                                        ...
                                        <textarea
                                            ...
                                            value={formData[`witness${num}_address`] || ""}
                                            onChange={handleChange}
                                            rows={2}
                                            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-green-500 transition"
                                        />
                                        ...
                                        <input
                                            ...
                                            value={formData[`witness${num}_postcode`] || ""}
                                            onChange={handleChange}
                                            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-green-500 transition"
                                        />
                                        ...
                                        <input
                                            ...
                                            value={formData[`witness${num}_telephone`] || ""}
                                            onChange={handleChange}
                                            className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-green-500 transition"
                                        />
                                    </div>
                        ...
                        <div className="text-center mt-12">
                            ...
                            {submitted && (
                                <p className="mt-8 text-green-700 font-semibold text-xl animate-pulse">
                                    Form submitted successfully – check server logs for complete JSON 🌿
                                </p>
                            )}
                            {error && (
                                <p className="mt-8 text-red-700 font-semibold text-xl">{error}</p>
                            )}
                        </div>
