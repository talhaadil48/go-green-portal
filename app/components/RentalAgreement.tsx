  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    const fullData = {
      ...
      signatures: Object.fromEntries(
        Object.entries(signatures).filter(([, v]) => v !== null)
      ),
      static_reminder:
      ...
      parking_fines:
        "To cover administration costs, a surcharge of £30 will be made for parking tickets left unpaid, in addition to the amount of the fine. The hirer accepts full responsibility to pay any congestion charge upon demand, together with an administration fee of £30 and any other associated costs/charges or penalties which may arise therefrom.",
      liability_statement:
    ...
    console.log("Submitted Form Data (JSON):", JSON.stringify(fullData, null, 2));
    setSubmitted(true);
  };
